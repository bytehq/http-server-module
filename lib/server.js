...
function terraform(call, callback) {
    console.debug('Terraform message received');
...
function pickup(call, callback) {
    console.debug('Pickup message received');
...
function rpcCall(call, callback) {
    console.debug('RPCCall message received');
...
function broadcastMessage(call) {
    console.debug('BroadcastMessage initialiser received');

    broadcastPublisher = call;
}

function roomStateMessage(call, callback) {
    console.debug('RoomState message received');
    ...
    call.on('data', function(message) {
        ...
        switch (message.type) {
            ...
            case 'update':
                ...
                break;
            case 'leave':
                world[roomId].states[uuid].emit('leave');
